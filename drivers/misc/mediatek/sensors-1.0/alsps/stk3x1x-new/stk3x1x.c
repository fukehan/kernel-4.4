...
*******************************************************************************/
#ifdef STK_TUNE0
#if defined(DROI_PRO_PD11)
	#define STK_MAX_MIN_DIFF	15 //200
	#define STK_LT_N_CT	10 //100
	#define STK_HT_N_CT	15 //150
#else
...
/******tyd -clc add tmd hardware info start******/
/*
...
*/
/******tyd -clc add tmd hardware info end******/
